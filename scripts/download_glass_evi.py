...
BASE_URL = "https://glass.hku.hk/archive/EVI/MODIS/250M/"
PRODUCT_PREFIX = "GLASS14D01.V10"
...
# The examples you pasted use h00v08. Keeping h18v03/h18v04 because those
# are the requested Germany MODIS tiles; change here if EVI uses another tile ID.
TILES = ["h18v03", "h18v04"]

OUTPUT_DIR = Path("data/glass_evi_modis_250m")
CHECKLIST_PATH = OUTPUT_DIR / "glass_evi_download_checklist.csv"
...
USER_AGENT = "Mozilla/5.0 GLASS-EVI-downloader"
...
def main() -> None:
    ...
    print(
        f"Downloading GLASS EVI targets: {len(targets)} files, "
