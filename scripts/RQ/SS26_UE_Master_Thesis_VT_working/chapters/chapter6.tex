...
\section{Comparison with Existing Techniques and Integrated Discussion}
Bring the findings together, compare them with  related studies, and discuss
Benefits of spatial aggregation
Value of high-resolution predictor structure
Limitations of native-footprint transfer
Agro-climatic variability
Usefulness of crop-pure SIF for yield modelling
Methodological limitations and practical applicability
