...
\begin{figure}[p]
    ...
    \caption{Sample 20m enhanced SIF map for select models. The CNN models are able to capture more complex shapes compared to the tree based models which delineate the field structure exactly.}
