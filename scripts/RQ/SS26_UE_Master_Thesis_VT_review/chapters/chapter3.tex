...
\caption{Summary of SIF enhancement methods for reconstruction, spatial downscaling, forecasting, retrieval improvement, and geostatistical gap filling. Many of the models are externally tested using GPP estimations. CFIS is SIF recorded airborne while tower SIF is recorded by ground based towers. The $\dagger$ indicates an unofficial acronym.}
