...
input_file <- "data/extracted_modis_data/df_wpar_338k.rds"
output_file <- "data/extracted_modis_data/df_wpar_338k_crop_counts.rds"
output_csv <- "data/extracted_modis_data/df_wpar_338k_crop_counts.csv"
